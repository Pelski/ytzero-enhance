...
- `webNavigation`: wykrycie nawigacji do obsługiwanych adresów YouTube;
...
- wymagane hosty YouTube: uruchomienie kontrolek wewnątrz `youtube.com/embed` i `youtube-nocookie.com/embed`;
...
- YouTube jako częścią strony/playera, który użytkownik sam otworzył.
